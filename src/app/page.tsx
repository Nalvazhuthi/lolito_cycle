...
const Home = () => {
  ...
  return (
    <div className="landing-page relative w-full min-h-screen overflow-x-hidden pt-[60px] pb-0">
      ...
      {/* Hero Section */}
      <div className="relative w-full h-[65vh] md:h-[75vh] sm:h-[60vh] z-0">
        <Image
          src={landingImage}
        ...
        {/* Overlay with text */}
        <div className="absolute inset-0 bg-black/50 flex flex-col justify-center items-start px-4 sm:px-6 md:px-16 text-white z-10">
